...
class PointTransformerV3(PointModule):
    def __init__(
        ...
        self.embedding_channels=enc_channels[0]
    ...
    def forward(self, features):
        ...
        output_features = conv(features)
        return output_features


class get_model(nn.Module):
    def __init__(self, num_classes, normal_channel=False, in_channels=6):
        super(get_model, self).__init__()
        adjusted_in_channels = in_channels + 3 if normal_channel else in_channels
        self.point_transformer_v3 = PointTransformerV3(in_channels=adjusted_in_channels)
        self.embed_dim = 1024
