...
def save_tensor_as_txt(args, points, filename):  
    ...
    file_path = args.output_dir#os.path.join(#,'example')
...
if __name__ == '__main__':
    ...
    if args.dataset == 'ModelNet40':
        ...
        args.NUM_CLASSES = 10
        clean_data_path = "./clean_data/modelnet40_normal_resampled"
    elif args.dataset == 'ShapeNetPart':
        args.NUM_CLASSES = 16
    ...
    if UMT_k == 2:
        args.output_dir = os.path.join("./UE", args.dataset, f"{args.slight_range}_{args.main_range}_{args.sca_min}_{args.sca_max}", "example")
    elif UMT_k == 3:
        args.output_dir = os.path.join("./UE", args.dataset, f"{args.slight_range}_{args.main_range}_{args.sca_min}_{args.sca_max}_20", "example")
    elif UMT_k == 4:
        args.output_dir = os.path.join("./UE", args.dataset, f"{args.slight_range}_{args.main_range}_{args.sca_min}_{args.sca_max}_20_0.4", "example")
    elif UMT_k == 1:
        args.output_dir = os.path.join("./UE", args.dataset, f"{args.slight_range}_{args.main_range}_1.0_1.0", "example")


    data_loader = load_data(args, clean_data_path)
